...
import { Link2, MousePointerClick, Shield, Zap, Globe } from "lucide-react";
...
const features = [
  {
    ...
    description:
      "Transform long, unwieldy URLs into short, clean links you can share anywhere.",
  },
  {
    icon: MousePointerClick,
    title: "Easy Management",
    description:
      "View, edit, and organize all your shortened links from one simple dashboard.",
  },
  {
    icon: Zap,
  ...
  },
  {
    ...
    description:
      "Your links are protected and always available, backed by serverless infrastructure.",
  },
  {
    icon: Globe,
    title: "Share Everywhere",
    description:
      "Use your short links in social media, emails, QR codes, and more.",
  },
];
...
const steps = [
  {
    step: "1",
    title: "Sign Up",
    description: "Create a free account in seconds with just your email.",
  },
  {
    step: "2",
  ...
  },
  {
    step: "3",
    title: "Share",
    description: "Copy your short link and start sharing it everywhere.",
  },
];
    ...
    <div className="flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center py-24 text-center gap-6">
        ...
        <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl max-w-3xl">
          Shorten & Share Your Links
        </h1>
        <p className="text-muted-foreground text-lg max-w-xl">
          The simplest way to create short, memorable URLs and share them
      ...
      <section className="py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground mt-2">
            Three simple steps to get your first short link.
          </p>
        </div>
